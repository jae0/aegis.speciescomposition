...
p0 = speciescomposition_parameters(
  ...
  ,
  theta0 =  list(
    pca1 = c( 7.640, 5.010, 10.728, -1.825, 9.331, 3.773, 7.283, 5.343, 4.019 ),
    pca2 = c( 7.640, 5.010, 10.728, -1.825, 9.331, 3.773, 7.283, 5.343, 4.019 ),
    pca3 = c( 7.640, 5.010, 10.728, -1.825, 9.331, 3.773, 7.283, 5.343, 4.019 ),   
    ca1 = c( 7.640, 5.010, 10.728, -1.825, 9.331, 3.773, 7.283, 5.343, 4.019 ), 
    ca2 = c( 7.640, 5.010, 10.728, -1.825, 9.331, 3.773, 7.283, 5.343, 4.019 ),
    ca3 = c( 7.640, 5.010, 10.728, -1.825, 9.331, 3.773, 7.283, 5.343, 4.019 )
  )
)
...
p0 = speciescomposition_parameters(
  ...
  theta0 = list( 
    ...
    pca2 = c(  5.561, 4.667, 6.375, 3.375, 8.600, 3.162, 5.643, 2.707, 3.406  ),
    pca3 = c(  5.561, 4.667, 6.375, 3.375, 8.600, 3.162, 5.643, 2.707, 3.406  ),
    ca1 =  c(  5.561, 4.667, 6.375, 3.375, 8.600, 3.162, 5.643, 2.707, 3.406   ),
    ca2 =  c(  5.561, 4.667, 6.375, 3.375, 8.600, 3.162, 5.643, 2.707, 3.406   ),
    ca3 =  c(  5.561, 4.667, 6.375, 3.375, 8.600, 3.162, 5.643, 2.707, 3.406   )
  )
)
